...
#Observacion: si se indica un beneficio en el servicio, este no entra en la regla, si el beneficio es null, si entra en la regla
  ...
  Scenario Outline: RULE 5  Quimioterapia
    ...
    Examples:
      ...
      | 1        | (cualquiera) |                              | (cualquiera) | QMT00010          | 1       | 002                 |                        |
      | 1        | (cualquiera) |                              | (cualquiera) | QMT01590          | 500     | 002                 |                        |
      | 1        | (cualquiera) |                              | (cualquiera) | TRA00670          | 5000    | 002                 |                        |
      | 1        | (cualquiera) |                              | (cualquiera) | PAQ00532          | 1       | 002                 |                        |
      | 1        | (cualquiera) |                              | (cualquiera) | PAQ00533          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | FAC00075          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | PRQ00196          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | PRQ02905          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | QRI00860          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | RIN00860          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | TRA00540          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | TRA00541          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | TRA00542          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | TRA00543          | 5000    | 002                 |                        |
      | 1        | != 12        | cualquiera excepto Oncosalud | (cualquiera) | TRA00544          | 5000    | 002                 |                        |
  ...
  Scenario Outline: RULE 11  Oncosalud beneficios 9043/9228/9225 (encounter scope, not_any_in)
    ...
    Examples:
      | order_id | sede | ambito | financiador | producto | plan | beneficio | codigo_autorizacion | tipo_encounter | codigo_prestacion | importe | cantidad | empresa        |
      | 1        | 4    | 1      | 999         | 1437     | 963  | 9043      | AUT-12345           | AMBULATORIO    | ECO00010          | 300     | 1        | ECOLAB PERU HO |
      | 1        | 4    | 1      | 999         | 1437     | 963  | 9228      | AUT-12345           | AMBULATORIO    | ECO00010          | 300     | 1        | ECOLAB PERU HO |
      | 1        | 4    | 1      | 999         | 1437     | 963  | 9225      | AUT-12345           | AMBULATORIO    | ECO00010          | 300     | 1        | ECOLAB PERU HO |
